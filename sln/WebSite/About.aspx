...
Por otra parte, los Servicios Web XML utilizan XML para enviar datos, garantizando así que cualquier cliente con capacidad XML puede recibir esos datos. Como XML es un estándar abierto, la mayoría de clientes modernos, como los sistemas operativos de PCs, teléfonos móviles, asistentes digitales personales (PDAs) y tablets, pueden aceptar datos XML. 
    ...
    <p class="style1">
        La idea central detrás de la plataforma .NET es la de software como servicio y 
        de cómo construir, instalar, consumir, integrar o agregar estos servicios para 
        que puedan ser accedidos mediante Internet.</p>
    <p class="style1">
        Es claro entonces que el objetivo de la plataforma .NET es simplificar el 
        desarrollo de aplicaciones Web, integrando las herramientas y tecnologías para 
        transformar a Internet en una plataforma de computación distribuida en gran 
        escala que soporta los estándares sobre los cuales se basan los servicios Web.</p>
...
<p class="style1">
    ...
    soportando completamente las tecnologías existentes de Internet, incluyendo HTML 
    ...
    aplicaciones Windows y los servicios Web XML. Las clases .NET son accesibles y 
    extensibles mediante la herencia.</p>
...
<p class="style1">
    ...
    como documentos XML, junto conl el&nbsp; SQL Server Management Studio para 
...
<p class="style1">
    Permitiendo crear bases de datos relacionales 
    para el procesamiento de transacciones o datos, con la creación de 
